...
from ink_writer.core.index.index_manager import IndexManager, WritingChecklistScoreMeta
from ink_writer.core.context.context_ranker import ContextRanker
...
from ink_writer.core.extract.genre_aliases import normalize_genre_token, to_profile_key
from ink_writer.core.extract.genre_profile_builder import (
    build_composite_genre_hints,
    extract_genre_section,
    extract_markdown_refs,
    parse_genre_tokens,
)
from ink_writer.core.extract.golden_three import (
...
class ContextManager:
    ...
    def _load_previous_memory_card(self, chapter: int, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if fallback["summary"] or fallback["next_chapter_bridge"] or involved_entities:
            try:
                from ink_writer.core.index.index_manager import ChapterMemoryCardMeta
