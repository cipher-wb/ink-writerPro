...
from ink_writer.core.infra.api_client import get_client
...
class RAGAdapter:
    ...
    def _backup_vector_db(self, reason: str) -> Path:
        ...
        backup_dir = self.config.ink_dir / "backups"
...
def main():
    ...
    if args.command == "stats":
        ...
        if not summary_text and config:
            summary_path = config.ink_dir / "summaries" / f"ch{args.chapter:04d}.md"
