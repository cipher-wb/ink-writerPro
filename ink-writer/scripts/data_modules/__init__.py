...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ChapterMemoryCardMeta": (".index_manager", "ChapterMemoryCardMeta"),
    "PlotThreadRegistryMeta": (".index_manager", "PlotThreadRegistryMeta"),
    "TimelineAnchorMeta": (".index_manager", "TimelineAnchorMeta"),
    "CandidateFactMeta": (".index_manager", "CandidateFactMeta"),
    # RAG Adapter
    ...
    "anti_ai_lint_text": (".anti_ai_lint", "anti_ai_lint_text"),
}
