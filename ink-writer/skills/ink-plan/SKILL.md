...
- 每章包含：目标/阻力/代价/时间锚点/章内时间跨度/与上章时间差/大卖点类型/大卖点描述/小卖点(×2)/爽点执行/压扬标记/Strand/反派层级/视角/关键实体/本章变化/章末未闭合问题/钩子/钩子契约/伏笔处置/明暗线推进
...
- **时间线表文件不存在或为空**
- 章纲文件不存在或为空
- 任一章节缺少：目标/阻力/代价/时间锚点/章内时间跨度/与上章时间差/大卖点类型/大卖点描述/小卖点(×2)/爽点执行/压扬标记/Strand/反派层级/视角/关键实体/本章变化/章末未闭合问题/钩子/钩子契约/伏笔处置/明暗线推进
