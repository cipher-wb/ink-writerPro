...
const FULL_DATA_GROUPS = [
    ...
    { key: 'chapterMemoryCards', title: '章节记忆卡', columns: ['chapter', 'goal', 'conflict', 'result', 'next_chapter_bridge'], domain: 'network' },
    { key: 'plotThreads', title: '剧情线程', columns: ['thread_id', 'title', 'status', 'priority', 'last_touched_chapter'], domain: 'network' },
    { key: 'timelineAnchors', title: '时间锚点', columns: ['chapter', 'anchor_time', 'previous_time_delta', 'to_location', 'countdown'], domain: 'network' },
    ...
    { key: 'candidateFacts', title: '候选事实', columns: ['chapter', 'entity_id', 'fact', 'confidence', 'status'], domain: 'quality' },
    ...
    useEffect(() => {
        ...
        async function loadAll() {
            ...
            const requests = [
                ...
                ['chapterMemoryCards', fetchJSON('/api/chapter-memory-cards', { limit: 100 })],
                ['plotThreads', fetchJSON('/api/plot-threads', { limit: 120 })],
                ['timelineAnchors', fetchJSON('/api/timeline-anchors', { limit: 100 })],
                ...
                ['candidateFacts', fetchJSON('/api/candidate-facts', { limit: 120 })],
