...
# 通过别名查找
python "${SCRIPTS_DIR}/ink.py" --project-root "$PROJECT_ROOT" index get-by-alias --alias "萧炎"

# 查询状态变化历史
python "${SCRIPTS_DIR}/ink.py" --project-root "$PROJECT_ROOT" index get-state-changes --entity "xiaoyan"
