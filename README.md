...
[![Version](https://img.shields.io/badge/Version-8.1.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 亮点 |
|------|------|
| **v8.1.0 (当前)** | ink-auto 智能升级：分层检查点（5/10/20章）、自动大纲生成、自动审查修复、增强完成报告 |
