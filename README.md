...
[![Version](https://img.shields.io/badge/Version-9.3.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.3.0 (当前)** | 工程审查优化：统一 .coveragerc 扩大覆盖范围、核心模块补充测试（IndexManager/StateManager/EntityLinker）、ink-auto 检查点逻辑提取为可测试 Python 模块、Dashboard CORS 收窄为 localhost、ink-5 缩减为纯重定向桩、覆盖率门槛提升 |
