...
[![Version](https://img.shields.io/badge/Version-13.3.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v13.3.0 (当前)** | 字数上限收紧（4000字硬上限）+ 双层进度条（内层12步骤/外层章节级 + 检查点子步骤追踪） |
