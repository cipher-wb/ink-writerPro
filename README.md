...
[![Version](https://img.shields.io/badge/Version-9.6.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.6.0 (当前)** | 工程审查优化：security_utils 测试覆盖 37%→69%、update_state 测试覆盖 39%→84%、整体覆盖率 71%→72%、jieba 可选依赖声明、历史审查报告归档 |
