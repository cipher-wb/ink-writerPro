...
[![Version](https://img.shields.io/badge/Version-9.9.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.9.0 (当前)** | 工程审查优化：发布流水线增加测试守门、CI 覆盖 Dashboard 变更、workflow_manager 覆盖率 58%→80%、Git Tag 补全 |
