...
[![Version](https://img.shields.io/badge/Version-9.14.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.14.0 (当前)** | 工程审查优化 — except Exception 精确化 + index_manager CLI 命令分发重构 + CI Python 3.12 矩阵 + 最低版本声明修正为 3.12 |
