...
[![Version](https://img.shields.io/badge/Version-9.5.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.5.0 (当前)** | 工程审查优化：活跃 Skill 中 ink-5 残留引用全部替换为 ink-auto、覆盖率门槛提升至 70%、Dashboard 版本对齐主版本、历史审查报告归档至 docs/archive/ |
