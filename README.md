...
[![Version](https://img.shields.io/badge/Version-9.11.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.12.0 (当前)** | 工程审查优化 — archive_manager/init_project 测试补齐突破 70% 阈值 + 覆盖率 81.92%→83%+ + ResourceWarning 根因定位（coverage+Python3.14 兼容性问题） |
