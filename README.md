...
[![Version](https://img.shields.io/badge/Version-9.16.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.16.0 (当前)** | 工程审查优化 — Lock 文件 prod/dev 拆分 + 测试 sys.path hack 清除 + 发布流水线 macOS 门禁 |
