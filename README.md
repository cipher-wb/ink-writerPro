...
[![Version](https://img.shields.io/badge/Version-9.15.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.15.0 (当前)** | 工程审查优化 — Python 版本声明修正 + 测试/生产依赖拆分 + CI macOS 矩阵 + SQLite 同步异常分级处理 |
