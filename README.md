...
[![Version](https://img.shields.io/badge/Version-9.8.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.8.0 (当前)** | 工程审查优化：package-lock.json 纳入版本同步工具、发布流水线集成前端构建、版本校验覆盖 Dashboard 前端 |
