...
[![Version](https://img.shields.io/badge/Version-13.6.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v13.6.0 (当前)** | 爽点密集化与主线加速架构级改造：大纲层爽点密度/前置原则/第1章闭环，正文层L7-L10四条新铁律，审查层卖点密度/摄像头检测/OOC本能违反/文笔工艺质量，润色层文笔工艺兜底 |
