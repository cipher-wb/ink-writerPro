...
[![Version](https://img.shields.io/badge/Version-9.13.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.13.0 (当前)** | 工程审查优化 — context_manager SQLite 连接泄漏修复 + conftest ResourceWarning 过滤器移除 + Dashboard server/watcher 测试补齐 + CLI 路由器覆盖率 50%→74% + 覆盖率 83%→84%+ |
