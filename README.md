...
[![Version](https://img.shields.io/badge/Version-9.17.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.17.0 (当前)** | 工程审查优化 — SQLite 连接泄漏修复 + 静默异常补充日志 + IndexManager 实例复用 + 覆盖率 84.42% |
