...
[![Version](https://img.shields.io/badge/Version-10.4.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v10.4.0 (当前)** | 写作质量约束升级 — 禁止时间标记开头 + 元数据泄漏清理 + ink-fix回溯修复 + 标题去重 + benchmark动态加载 |
