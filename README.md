...
[![Version](https://img.shields.io/badge/Version-9.10.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.10.0 (当前)** | 工程审查优化：CI Python 版本与 Lock 文件对齐 3.14、migration_auditor 测试覆盖 0%→90%+、runtime_compat/security_utils pragma 标注、CI 触发路径覆盖 Agent/Skill 变更、Dashboard 纳入覆盖率统计、删除已废弃 ink-5 Skill |
