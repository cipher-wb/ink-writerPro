...
[![Version](https://img.shields.io/badge/Version-9.4.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.4.0 (当前)** | 工程审查修复：覆盖率范围扩大到 scripts 全层（data_modules→scripts）、ink.py 注册 checkpoint/report-check/disambig-check 子命令消除 Bash/Python 双写、ink-auto.sh bare except 修复、scripts/\_\_init\_\_.py 版本号纳入同步检查、docs/architecture.md 更新至 14 Skills + 14 Agents |
