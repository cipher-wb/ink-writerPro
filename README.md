...
[![Version](https://img.shields.io/badge/Version-9.7.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v9.7.0 (当前)** | 工程审查优化：删除死代码 golden_three_checker.py、anti_ai_scanner 补测试、Dashboard path_guard 安全测试、CI 新增 dashboard import 检查、共用 conftest.py 抽取、审查报告归档整理 |
