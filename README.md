...
[![Version](https://img.shields.io/badge/Version-13.5.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 说明 |
|------|------|
| **v13.5.0 (当前)** | Narrative Coherence Engine：否定约束管线（Data→Context→Writer→Checker全链路）、场景退出快照、Writer自洽回扫(Step 2A.1)、角色连续性📌预警、O7否定约束违反检测、L9枚举完整性检测。从根源杜绝凭空编造和章内矛盾 |
