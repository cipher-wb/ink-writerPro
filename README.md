...
[![Version](https://img.shields.io/badge/Version-9.0.0-green.svg)](ink-writer/.claude-plugin/plugin.json)
...
| 版本 | 亮点 |
|------|------|
| **v9.0.0 (当前)** | Harness-First 架构改造：命令收口（4 主入口）、计算型闸门（Step 2C）、Reader Agent 升格为核心裁判（7 维评分）、ink-migrate 迁移工具、ink-auto 增强输出 |
